...
def findout_rule_from_policiesdatabase(in_devicename, in_destinationip, in_src_application, in_dst_application, in_fromzone, in_tozone, in_proto_application, in_sourceip, policies_filename, using_deviceinfo_values, policymatch_status, in_matchedpolicy, file_contents_lists):
      ...
      try:
        ...
        for _dictData_values_ in data_from_CURL_command:
           ...
           for _keyname_ in in_matchedpolicy_keynameslist:
              ...
              th = threading.Thread(target = findout_rule_from_policiesdatabase, args=(in_devicename, in_destinationip, in_src_application, in_dst_application, in_fromzone, in_tozone, in_proto_application, in_sourceip, policies_filename, using_deviceinfo_values, policymatch_status, in_matchedpolicy, file_contents_lists,))
              th.start()
              _threads_.append(th)
           for th in _threads_:
              th.join()
        ...
        return Response(tatalsearched_values.values())
